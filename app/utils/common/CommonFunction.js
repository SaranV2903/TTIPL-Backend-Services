...
const fs = require("fs");
let content1= path.join(process.cwd(),'app','utils','RegistrationForm',"Speedaway_KYC.pdf")
let contet2=path.join(process.cwd(),'app','utils','RegistrationForm',"Speedaway_Pistoneer_Form.pdf")
